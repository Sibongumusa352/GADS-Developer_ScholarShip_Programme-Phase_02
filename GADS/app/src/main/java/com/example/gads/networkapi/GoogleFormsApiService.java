...
public class GoogleFormsApiService {
    ...
    public static void submitProject(ProjectObject submission, @NonNull final ApiResponseCallback<Void> callback) {
        retrofitInterface.submitProject(submission.getName(), submission.getSurname(), submission.getEmail(), submission.get_url())
